    ...
    <div class="app-view -help">
      <section>
        ...
        <p>
          ...
          If there's a
          <i class="constraint constraint-other" />
          icon or "other" listed in the checker, that means the game has
          additional rules that cannot be checked by the program.
        </p>
        <p>
      ...
      <section id="help__parity">
        <h2 class="h2">Parity</h2>
        <p>
